...
describe('a RegisterUser entities', () => {
  ...
  it('should throw error when username contains more than 50 character', () => {
    // Arrange
    const payload = {
      username: 'adminadminadminadminadminadminadminadminadminadminadminadminadmin',
      fullname: 'Admin',
      password: 'secret',
    };
    // Action and Assert
  ...
  it('should throw error when username contains less than 5 character', () => {
    // Arrange
    const payload = {
      username: 'admi',
      fullname: 'Admin',
    ...
    // Action and Assert
    expect(() => new RegisterUser(payload)).toThrowError('REGISTER_USER.USERNAME_LESS_THAN_MINIMUM_CHAR');
  });
